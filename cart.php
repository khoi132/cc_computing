...
<html>
 <head>
 <title>Welcome to the shopping cart</title>
 ...
 <br />
 <br />
 <h3 align="center">Welcome to the shopping cart<a href="demobanhang.php"> Home
 </a> </h3><br />
 <br /><br />
 <?php
 ...
 <img src="Img/<?php echo $row["product_image"]; ?>"style="width: 300px;height: 200px"; class="img-responsive" /><br />
